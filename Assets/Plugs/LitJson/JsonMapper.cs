            ...
            if (reader.Token == JsonToken.ArrayStart) {
                ...
                while (!done) {
                    ...
                    if (tdata.Properties.TryGetValue(property, out pdata)) {
                        ...
                        //    throw new NotSupportedException("�ֵ�����л�����֧��" + valueType.GenericTypeArguments[0].Name + "���͵�key");
                        //}
                        //object v;
                        ...
                        //}
                        //else {
                        //    throw new NotSupportedException("�ֵ�����л�����֧��" + valueType.GenericTypeArguments[1].Name + "���͵�value");
                        //}
                        ...
                        if (valueType.GetGenericArguments() != null && valueType.GetGenericArguments().Length > 0) {
                            ...
                            if (keyimporter != null) {
                                ...
                                try {
                                    ...
                                    throw new NotSupportedException("�ֵ�����л�����֧��" + valueType.GetGenericArguments()[0].Name + "���͵�key");
                                }
                            }
                        }
                        else {
